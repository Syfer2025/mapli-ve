...
| [024](ADR-024-deterministic-supersampling.md)        | Suavização por supersampling, no nosso código         | aceito — implementado                     | fator não inteiro, teto maior, ou custo acima de 30 ms/MP          |
| [025](ADR-025-motion-blur-accumulation.md)           | Motion blur por acumulação de subframes no compositor | **aceito**                                | custo acima de 250 ms/frame em 4K, ou blur de câmera no mapa       |
