...
| [022](ADR-022-export-resolution-from-composition.md)   | Resolução do export vem da composição                   | aceito, emenda o 013; teto pelo 034       | editar durante export                                              |
...
| [024](ADR-024-deterministic-supersampling.md)          | Suavização por supersampling, no nosso código           | aceito — implementado; teto pelo 034      | fator não inteiro ou custo acima de 30 ms/MP                       |
| [025](ADR-025-motion-blur-accumulation.md)             | Motion blur por acumulação de subframes no compositor   | **aceito — implementado**                 | custo acima de 250 ms/frame em 4K, ou blur de câmera no mapa       |
| [026](ADR-026-map-view-is-document-state.md)           | Vista do mapa é estado do documento                     | **aceito — implementado**                 | mais de uma vista simultânea do mapa na mesma composição           |
| [027](ADR-027-fail-closed-and-atomic-export.md)        | Export falha fechado e publica arquivo atomicamente     | **aceito — implementado**                 | política de settle ou publicação mudar                             |
| [028](ADR-028-scene-script-compiler.md)                | Scene Script compila por fronteira pura e transacional  | **aceito — implementado**                 | novo formato ou edição inversa completa                            |
| [029](ADR-029-versioned-disposable-plugin-boundary.md) | Plugin usa fronteira versionada e descartável           | **aceito — núcleo implementado**          | distribuição de plugins de terceiros não confiáveis                |
| [030](ADR-030-safe-property-expressions.md)            | Expressão usa linguagem interpretada e fechada          | **aceito — implementado**                 | acesso entre propriedades ou mudança do runtime JS                 |
| [031](ADR-031-preview-cache-and-reference-audio.md)    | Preview e áudio são artefatos derivados determinísticos | **aceito — núcleo implementado**          | cache abaixo de 60 fps ou edição/mixagem de áudio                  |
| [032](ADR-032-shortcuts-and-workspace-presets.md)      | Atalhos e presets são preferências locais fail-safe     | **aceito — implementado**                 | múltiplos perfis ou sincronização entre máquinas                   |
| [033](ADR-033-durable-render-queue-checkpoints.md)     | Fila persiste checkpoints e só retoma sequências        | **aceito — implementado**                 | retomada H.264 ou jobs entre máquinas                              |
| [034](ADR-034-direct-8k-with-conformance-guard.md)     | 8K usa superfície direta com guarda de conformidade     | **aceito — implementado**                 | saída acima de 8192 px ou falha recorrente em GPUs suportadas      |
